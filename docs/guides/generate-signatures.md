...
You can generate a signature using a private key with {{% cli signature-new %}}.  This command generates a cryptographic hash from a private for the data provided as an argument or from stdin.
...
$ rot signature-ver rot/badSigner HelloWorld ed25519:s5AFx9ohilblnb1Fu5hlRiHB3qCYkL+rD3vyOF4xgG3CIbura2lcLnmNihVI4zmEyPtat4y4zq3rMv7o+kFDDw==:goodSigner
