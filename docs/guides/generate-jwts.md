...
You'll need to generate a private key to sign the JWT.  The easiest way to do this is using {{% cli value-private %}} (encrypting the keys into Rot) or {{% cli key-new %}} (printing the keys to stdout).
